...
/*
	...
	NOTICE: THIS IS NOT ACTUALLY A PART OF JCLIB
...
namespace jc
{
	...
	namespace impl
	{
		...
		static std::vector<std::basic_string_view<_Elem, _Traits>> split(const std::basic_string_view<_Elem, _Traits>& _str, const T& _token, size_t _tokenLen)
		{
			size_t _offset = 0;
			size_t _atpos = 0;
